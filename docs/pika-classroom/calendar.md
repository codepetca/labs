...
- Review the 8-week builder rhythm.
- Pick a first project direction or task.
...
- Mention where AI helped.
- Name one blocker or question.
...
- Share what changed since Week 1.
- Discuss early project direction.
- Confirm the next small build target.
